...
public class HdfsAllowSnapshot extends HdfsAbstract {
    ...
    public HdfsAllowSnapshot(String name, Direction directionContext) {
        super(name, directionContext);
    }

    public HdfsAllowSnapshot(String name, Direction directionContext, int directives) {
        super(name, directionContext, directives);
    }

    public HdfsAllowSnapshot(String name, Direction directionContext, int directives, boolean directivesBefore, boolean directivesOptional) {
